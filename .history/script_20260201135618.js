...
// Play music function - using direct audio or fallback
function playMusic() {
  try {
    // Try using HTML5 audio with a public royalty-free romantic music source
    const audioPlayer = document.createElement("audio");
    audioPlayer.id = "celebration-music";
    audioPlayer.autoplay = true;
    audioPlayer.style.display = "none";
    
    // Using a royalty-free romantic music track from a public CDN

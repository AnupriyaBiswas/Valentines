...
function placeNoNearYes() {
  ...
  if (window.innerWidth <= 768) {
    // Mobile: Position below Yes button
    const x = yesRect.left - containerRect.left + (yesRect.width / 2) - (noBtn.offsetWidth / 2);
    const y = yesRect.bottom - containerRect.top + 10; // 10px below

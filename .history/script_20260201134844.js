...
// Play music function - using Web Audio API with a workaround
function playMusic() {
  // Create audio context and play a simple tune, or use a direct audio file
  try {
    // Create a hidden audio element with autoplay
    const audio = new Audio();
    audio.src = "https://www.youtube.com/watch?v=xRmlbdy-dtU"; // This won't work directly
    
    // Better approach: Use Spotify or another service
    // Or try using YouTube's nocookie embed
    const musicPlayer = document.createElement("div");
    musicPlayer.id = "music-player";
    musicPlayer.style.position = "fixed";
    musicPlayer.style.bottom = "-9999px";
    musicPlayer.innerHTML = `<iframe width="100" height="100" src="https://www.youtube.com/embed/xRmlbdy-dtU?start=63&autoplay=1&mute=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>`;
